 ...
 *  Can be tested by invoking the test Str002V3ServiceTest.
 *  The interface Str002V3Service can be customized to enabling passing parameters to the service, and this class can consume the parameters within the relevant screens.
 */
@Service(name = "Str002V3")
@OpenlegacyDesigntime(editor = "WebServiceEditor")
@Component
public class Str002V3ServiceImpl implements Str002V3Service {
    ...
    @Override
    @ServiceMethod(name = "getStr002V3", entities = {
            @EntityMapping(alias="interbank", entity=com.poc_accountscanonicalsummary.openlegacy.Interbank.class)})
    @LogServiceUsage
    @BindInputs(endpoints = {
            @BindTo(endpoint = "interbank.bsec0198Commarea", expression = "bsec0198Commarea"),
    ...
    public Str002V3Out getStr002V3(Str002V3In str002V3In) throws Exception {
        Str002V3Out str002V3Out = new Str002V3Out();
        ...
        try {
            ...
            Interbank interbank = serviceBinder.bindInputs(this, "getStr002V3", "interbank", new Interbank(), str002V3In);
            interbank = pocAccountscanonicalsummarySdkSession.doAction(ActionUtil.getRpcAction(Interbank.class), interbank);
            /* autogenerated - execution block end */;

            /* autogenerated - output block start */;
            str002V3Out = serviceBinder.bindOutput(this, "getStr002V3", str002V3Out, new String[]{"str002V3In", "interbank"}, str002V3In, interbank);
