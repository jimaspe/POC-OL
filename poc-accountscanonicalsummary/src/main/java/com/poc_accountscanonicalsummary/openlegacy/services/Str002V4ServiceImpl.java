 ...
 *  Can be tested by invoking the test Str002V4ServiceTest.
 *  The interface Str002V4Service can be customized to enabling passing parameters to the service, and this class can consume the parameters within the relevant screens.
 */
@Service(name = "Str002V4")
@OpenlegacyDesigntime(editor = "WebServiceEditor")
@Component
public class Str002V4ServiceImpl implements Str002V4Service {
    ...
    @Override
    @ServiceMethod(name = "getStr002V4", entities = {
    ...
    public Str002V4Out getStr002V4(Str002V4In str002V4In) throws Exception {
        Str002V4Out str002V4Out = new Str002V4Out();
        ...
        try {
            ...
            Interbank interbank = serviceBinder.bindInputs(this, "getStr002V4", "interbank", new Interbank(), str002V4In);
            interbank = pocAccountscanonicalsummarySdkSession.doAction(ActionUtil.getRpcAction(Interbank.class), interbank);
            /* autogenerated - execution block end */;

            /* autogenerated - output block start */;
            str002V4Out = serviceBinder.bindOutput(this, "getStr002V4", str002V4Out, new String[]{"str002V4In", "interbank"}, str002V4In, interbank);
